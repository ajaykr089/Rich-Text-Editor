...
Reusable Editora logos for docs, demos, and product surfaces.
...
| Surface | Type | Notes |
| --- | --- | --- |
| `/img/brand/editora_logo_blocks.svg` | Static SVG asset | Primary light logo for docs/marketing surfaces |
| `/img/brand/editora_logo_blocks_dark.svg` | Static SVG asset | Dark-surface variant of primary logo |
| `/img/brand/editora_logo_cursor.svg` | Static SVG asset | Compact icon/mark for small surfaces |
| `/img/brand/editora_logo_cursor_dark.svg` | Static SVG asset | Compact dark-surface icon variant |
| `/img/brand/editora_logo_cursor_animated.svg` | Animated SVG asset | Motion-friendly brand mark for hero/loading usage |

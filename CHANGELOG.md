...
### Changed
- Release preparation for `@editora/core`, `@editora/plugins`, `@editora/react`, and `@editora/themes`.
- Updated publish metadata and declaration entrypoint alignment for npm consumers.
